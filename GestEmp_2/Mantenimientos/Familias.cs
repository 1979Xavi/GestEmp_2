	...
	public partial class Familias : Form
	{
		...
		private void cargaDatos()
		{
			try
			{
				...
				dtgvDatos.DataSource = BaseDeDatos.ExecuteSelect(true, "Select idFamilia, CodigoFamilia, Descripcion from MantFamilias");
		...
		private void bAceptar_Click(object sender, EventArgs e)
		{
			try
			{
				...
				if (accionPantalla == "N")
				{
					...
					strSql = "Insert into MantFamilias (idFamilia, CodigoFamilia, descripcion, Activo, usuarioCreacion, fechaHoraCreacion) Values ('" +
							guid + "', '" +
							tCodigo.Text + "', '" +
							tDescripcion.Text + "', " +
							"1, 'SYSTEM','" +
				...
				{
					strSql = "Update MantFamilias Set CodigoFamilia = '" + tCodigo.Text + "', Descripcion = '" + tDescripcion.Text +
					", UsuarioModificacion = 'SYSTEM', FechaHoraModificacion = '" + DateTime.Now.ToString() + "'" +
					" Where idFamilia = '" + tId.Text + "'";
				}
		...
		private void bSalir_Click(object sender, EventArgs e)
		{
			try
			{
				DialogResult dialogResult = MessageBox.Show("¿Desea salir del Mto. de Familias?", "Mto. Familias", MessageBoxButtons.YesNo);
		...
		private void MuestraDetalle(string id)
		{
			try
			{
				...
				tId.Text = id;
				string strSQl = "Select idFamilia, CodigoFamilia, Descripcion" +
					" from MantFamilias " +
					" where idFamilia = '" + id + "'";
				...
				if (dtgvDatos.Rows.Count > 0)
				{
					tCodigo.Text = dtDetalle.Rows[0]["codigoFamilia"].ToString();
